...
def main(image_dir, output_graph, output_labels, summaries_dir, how_many_training_steps, testing_percentage,
         validation_percentage,
         eval_step_interval, train_batch_size, test_batch_size, validation_batch_size, bottleneck_dir,
         final_tensor_name, flip_left_right,
         random_crop, random_scale, random_brightness, model_dir, learning_rate, checkpoint_directory,
         delete_checkpoint,
    ...
    return ('Final test accuracy = %.1f%% (N=%d), Cross Entropy Value: %s, Misclassified Images: %s' % (
    test_accuracy * 100, len(test_bottlenecks),

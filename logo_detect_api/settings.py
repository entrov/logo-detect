...
# Deployment Doc for DigitalOcean: https://docs.digitalocean.com/tutorials/app-deploy-django-app/
...
DEBUG=True
ALLOWED_HOSTS = os.getenv("DJANGO_ALLOWED_HOSTS","172.31.30.94,178.128.153.108,127.0.0.1,localhost,*,3.88.155.223").split(",")
